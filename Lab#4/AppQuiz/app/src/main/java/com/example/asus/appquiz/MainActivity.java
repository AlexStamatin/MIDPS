package com.example.asus.appquiz;
...
import com.example.asus.appquiz.Adapter.GridViewAnswerAdapter;
import com.example.asus.appquiz.Adapter.GridViewSuggestAdapter;
import com.example.asus.appquiz.Common.Common;
    ...
    private void initView() {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Corect ! Rezultatul este "+result,Toast.LENGTH_SHORT).show();
